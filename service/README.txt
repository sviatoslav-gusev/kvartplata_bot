...
install.sh
    To be able run install.sh:
        place kvartplata_bot binary to this directory
...
kvartplata_bot.service
    Service to be runned.
        Start/Stop/Restart:     systemctl start|stop|restart kvartplata_bot.service
        Status:                 systemctl status kvartplata_bot.service
        Logs (journal):         journalctl -u kvartplata_bot.service -f